...
![Carte de localisation du site de Kleinaitingen](./carte_localisation.svg)
...
![Relation généalogique père-fils](./relation_genealogique.svg)

---

## 📊 Chronologie et Datations

![Chronologie des datations radiocarbones](./chronologie.svg)

---

## 🧬 Données Génétiques Comparées

![Comparaison des données génétiques](./donnees_genetiques.svg)

---

## 🌍 Analyse des Isotopes (Mobilité et Origine)

![Analyse des isotopes](./isotopes.svg)

---

## ⚱️ Contexte Funéraire

![Tombes adjacentes et mobilier funéraire](./tombes.svg)

### Poignard Orné de Kleinaitingen

<img src="./pieces.jpeg" alt="Poignard orné de la tombe de Kleinaitingen" style="zoom:33%;" />
